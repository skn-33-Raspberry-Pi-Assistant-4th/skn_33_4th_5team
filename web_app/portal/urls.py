...
urlpatterns = [
    ...
    path("api/ai/jobs/<uuid:job_id>", views.ai_job_status_api, name="ai_job_status_api"),
    path("api/ai/jobs/<uuid:job_id>/cancel", views.ai_job_cancel_api, name="ai_job_cancel_api"),
