...
6. 각 문항의 evidence_ids에는 허용된 evidence ID 하나만 넣으세요. supporting_quotes는 문자열이 아니라 원문 인용 문자열 하나를 담은 배열이어야 합니다. 예: "supporting_quotes": ["원문 인용"]. 인용은 해당 evidence 원문의 연속 문자열을 그대로 복사하고, 정규화 후 15~240자여야 하며 정답과 explanation을 직접 뒷받침해야 합니다. explanation은 그 범위를 넘어서면 안 됩니다.
